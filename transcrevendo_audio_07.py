...
No final, devem ser apresentados todos os acordos e combinados
...
def listar_reunioes():
    ...
    for pasta_reuniao in lista_reunioes:
        data_reuniao = pasta_reuniao.stem # pega apenas o nome da pasta
        ano, mes, dia, hora, min, seg = data_reuniao.split('_')
        # Exemplo: {2025_10_30_10_00_00: '2025/10/30 10:00:00'}
...
def tab_selecao_reuniao():
    ...
    if len(reunioes_dict) > 0:
        ...
        if not (pasta_reuniao / 'titulo.txt').exists():
            ...
            st.button('Salvar', on_click=salvar_titulo,
